      ...
      <header className="bg-white/10 backdrop-blur-xl border-b border-white/10 px-8 py-4 flex justify-between items-center sticky top-0 z-50">
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <button onClick={onLogout} className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-white/50 hover:bg-white/10 hover:text-white transition-all">
