...
const App: React.FC = () => {
  ...
  const [currentPage, setCurrentPage] = useState<'landing' | 'onboarding' | 'dashboard' | 'curriculum' | 'interview' | 'mentor' | 'analyzer' | 'jobmatch' | 'techscout' | 'mockassessment'>('landing');
  ...
  const handleOnboardingComplete = (prefs: UserPreferences) => {
    setProgress(prev => ({
      ...
      // We don't clear completedTopicIds here so users can update preferences without losing progress
    }));
    setCurrentPage('dashboard');
  };
